...
fn html_macro_tests() {
    ...
    t.pass("tests/html_macro_tests/expressions/single_braced_expression_pass.rs");
    //t.compile_fail("tests/html_macro_tests/expressions/single_braced_expression_fail.rs");
    ...
    t.pass("tests/html_macro_tests/elements/element_with_single_value_pass.rs");
